...
$config="C:\@inf\winbuild\scripts\enforce.conf"

$logfile="C:\@inf\winbuild\logs\$(Get-Date -Format 'yyyy-MM-dd-HHmmss').txt"
...
mkdir "C:\@inf\winbuild\logs" -ErrorAction SilentlyContinue
